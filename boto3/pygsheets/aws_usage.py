...
def security_group_worksheet_creation(spread_sheet, Header, header_data, cells_data):
    ...
    worksheet = worksheet_creation(spread_sheet, header_data, worksheet_name="Idle security group", worksheet_rows=10, worksheet_cols=3)
...
def elastic_IP_worksheet_creation(spread_sheet, Header, header_data, cells_data):
    ...
    worksheet = worksheet_creation(spread_sheet, header_data, worksheet_name="elastic IP", worksheet_rows=2, worksheet_cols=9)
...
def snapshot_worksheet_creation(spread_sheet, Header, header_data, cells_data):
    ...
    worksheet = worksheet_creation(spread_sheet, header_data, worksheet_name="snapshot", worksheet_rows=100000, worksheet_cols=len(header_data)+1)
...
def main():
    ...
    for func in (   ec2_worksheet_creation,
                    ...
                    security_group_worksheet_creation,
